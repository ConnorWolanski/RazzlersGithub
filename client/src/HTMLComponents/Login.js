  ...
  render()
  {
    return(
      <div>
        ...
        <button type="submit" id="loginButton" onClick={() => loginVerification(document.getElementById("usernameInput").value, document.getElementById("passwordInput").value)}>Login</button>
      </div>
    );
  }
}
